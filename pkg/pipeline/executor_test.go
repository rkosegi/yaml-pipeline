...
func TestExecute(t *testing.T) {
	...
	assert.Equal(t, "abcd", gd.Get(pp.MustParse("leaf")).AsLeaf().Value())
	assert.Equal(t, "abcd", gd.Get(pp.MustParse("sub1.sub2.leaf")).AsLeaf().Value())
	...
	assert.Equal(t, "720", gd.Get(pp.MustParse("Results.Factorial")).AsLeaf().Value())
...
func TestExecuteImport(t *testing.T) {
	...
	assert.Equal(t, "abcdef", gd.Get(pp.MustParse("wrapped.root.sub1.leaf2")).AsLeaf().Value())
}
...
func TestExecutePatch(t *testing.T) {
	...
	assert.Equal(t, "abcd", gd.Get(pp.MustParse("root.leaf")).AsLeaf().Value())
}
...
func TestExecuteInnerSteps(t *testing.T) {
	...
	assert.Equal(t, 456, gd.Get(pp.MustParse("root.sub")).AsLeaf().Value())
}
...
func TestExecuteForEachFileGlob(t *testing.T) {
	...
	assert.Equal(t, 2, len(gd.Get(pp.MustParse("import.files")).AsContainer().Children()))
